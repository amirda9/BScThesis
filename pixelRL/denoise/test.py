...
def TEST(loader, agent, fout):
    ...
    for i in range(0, 10):
        img = cv2.imread('/home/amir/Desktop/Webcam-Eyetracking/Final/noisy/{}.jpg'.format(i),cv2.IMREAD_GRAYSCALE) 
        ...
        cv2.imwrite('./res/'+str(i)+'_noise.png',I)
        cv2.imwrite('./res/'+str(i)+'_original.png',img)
